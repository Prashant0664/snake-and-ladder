...
const Leftbar = () => {
    ...
    const [start, cstart] = React.useState(eval(localStorage.getItem("start")));
            ...
            <div className={`${start ? "hidden" : ""}bg-slate-300 text-black absolute top-0 w-[300px] lfb11 h-[100%]`}>
                <div className='lsbmc'>
                    <form className='py-[5%] px-[8%]'>
                        <label className={`${!start ? "" : "hidden"} lfb11`}>Enter Number of Players</label>
                        <br />
                        ...
                        <br />
                        <div className='flex lfnb gap-[10%] top-0 justify-center'>
                        ...
                        }} className={`${!start ? "" : "hidden"} text-center lsbstg flex justify-center w-[100%] bg-green-500 text-slate-200 mt-4 h-[45px] items-center text-2xl hover:scale-110 hover:shadow-lg `}>Start</button>
                    <button type="button" onClick={() => {
                            cstart(!start);
                            localStorage.setItem("n1", 0);
                            localStorage.setItem("n2", 0);
                ...
                <div className={` absolute float-left md:w-[130px] w-[280px] lg:w-[160px] xl:w-[200px] mx-auto px-auto flex justify-evenly bottom-0  mt-[100%] mb-[10px] `}>
                    <a href='https://github.com/Prashant0664/snake-and-ladder' target='_blank'><AiOutlineGithub className={`text-[26px] hover:scale-110`} /></a>
                    <a href='https://www.linkedin.com/in/prashant-693591228' target='_blank'><AiFillLinkedin className={`text-[26px] hover:scale-110`} /></a>
                </div>
